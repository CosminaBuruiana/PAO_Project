...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public Optional<Appointment> getById(UUID id) {
        return appointmentRepository.getObjectById(id);
    }
    ...
    public void addOnlyOne(Appointment Appointment) {
        appointmentRepository.addNewObject(Appointment);
    }

    @Override
    public void removeElementById(UUID id) {
        appointmentRepository.deleteObjectById(id);
    }

    @Override
    public void modificaElementById(UUID id, Appointment newElement) {
        appointmentRepository.updateObjectById(id, newElement);
    }
